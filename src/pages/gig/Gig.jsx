...
const Switcher = () => {
  ...
  const handleToggle = () => {
    setOpcaoSelecionada((prevOpcao) => (prevOpcao === 'primeira opção' ? 'segunda opção' : 'primeira opção'));
  };

  return (
    <div>
      <label>
        <input type="checkbox" checked={opcaoSelecionada === 'primeira opção'} onChange={handleToggle} />
